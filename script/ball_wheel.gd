...
var ball_texture = [preload("res://art/balls/ball1.png"), \
					preload("res://art/balls/ball2.png"), \
					preload("res://art/balls/ball3.png"), \
					preload("res://art/balls/ball4.png"), \
					preload("res://art/balls/ball5.png"), \
					preload("res://art/balls/ball6.png"), \
					preload("res://art/balls/ball7.png"), \
					preload("res://art/balls/ball8.png")]
